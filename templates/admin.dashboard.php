                ...
                <div class="col-md-8 col-lg-9">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="track-order" role="tabpanel" aria-labelledby="track-order-tab"
                            tabindex="0">
                            <h5 class="tab-title">Add new category here</h5>
                            <p>Add a new category below. Kindly fill in the category name and the category image
                            </p>
                            <form method="POST" action="../controllers/category_controller.php" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="order-id" class="form-label">Category name</label>
                                    <input type="text" class="form-control" id="order-id" name="category_name" aria-describedby="helpingLine" required>
                                    <!-- <div id="helpingLine" class="form-text">Found in your order confirmation email</div> -->
                                </div>
                                <div class="mb-3">
                                    <label for="billing-email" class="form-label"> Category image</label>
                                    <input type="file" class="form-control" accept="image/png, image/jpeg, image/jpg" name="image_file" required>
                                </div>
